	...
	return (
		<Card className="bg-background">
			<CardHeader>
				...
				<CardDescription>
					Automatically provision S3, CloudFront, and Route 53 to serve
					this application as a static site. The subdomain is created
					automatically in your Route 53 hosted zone.
				</CardDescription>
			</CardHeader>
			<CardContent>
				<Form {...form}>
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormDescription>
											Leave blank to auto-generate: dokploy-{"{appname}"}-{"{id}"}
										</FormDescription>
										<FormMessage />
									</FormItem>
								)}
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormDescription>
											Leave blank if the repository already contains pre-built files.
										</FormDescription>
										<FormMessage />
									</FormItem>
								)}
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormDescription>
											Directory containing the static files to upload (e.g. dist, build, out, public).
										</FormDescription>
										<FormMessage />
									</FormItem>
								)}
						...
						<div className="flex gap-3 flex-wrap">
							...
							{existing && existing.status !== "active" && (
								...
								>
									...
									{isProvisioning ? "Provisioning…" : "Provision AWS Infrastructure"}
								</Button>
							)}
						</div>
					</form>
